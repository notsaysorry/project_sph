        ...
        <div class="InfoWrap">
          ...
          <div class="choose">
            <div class="chooseArea">
              ...
              <dl v-for="skuSaleAttr in spuSaleAttrList" :key="skuSaleAttr.id">
                <dt class="title">{{ skuSaleAttr.saleAttrName }}</dt>
                <dd
                  changepirce="0"
                  :class="{ active: spuSaleAttrValue.isChecked == '1' }"
                  v-for="spuSaleAttrValue in skuSaleAttr.spuSaleAttrValueList"
...
export default {
  ...
  mounted() {
    ...
    this.$store.dispatch("detail/categoryList", this.$route.params.goodId);
  },
  computed: {
